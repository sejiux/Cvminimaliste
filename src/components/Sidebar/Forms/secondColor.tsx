  ...
  return (
    <div className="pl-1 pr-6 py-5 text-[#303030] h-auto overflow-x-hidden">
      <div className="space-y-2">
        <h3 className="font-PoppinsBold text-gray-400 text-lg">Couleurs Secondaire</h3>
        <hr />
        <h3 className="font-PoppinsBold text-[#191919] text-xs pt-3">Couleurs des textes</h3>
        <GithubPicker
          onChange={(data: any) => modelsService.addSecondTextColor(data.hex)}
          width="100%"
          colors={['#fff', '#000']}
          triangle="hide"
        ...
        <GithubPicker
          onChange={(data: any) => modelsService.addSecondBgColor(data.hex)}
          width="100%"
          colors={colorsPicker}
          triangle="hide"
          className="colorsPicker"
